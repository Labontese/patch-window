...
excerpt: "OpenBSD 7.9 shipped May 19. Two standout additions: a scheduler that handles mixed performance and efficiency cores, and unlocked socket splicing for better multi-core throughput."
draft: false
lang: en
---
