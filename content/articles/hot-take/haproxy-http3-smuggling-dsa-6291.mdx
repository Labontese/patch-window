...
excerpt: "CVE-2026-33555: HAProxy's HTTP/3 parser skips body size validation on stream close, enabling request smuggling. One zero-byte QUIC packet is enough. Debian DSA-6291-1 is out."
draft: false
lang: en
---
