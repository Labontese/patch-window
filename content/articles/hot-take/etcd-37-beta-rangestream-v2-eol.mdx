...
excerpt: "etcd 3.7 beta brings RangeStream for large key-range queries and permanently removes the v2 API. etcd 3.4 is EOL. What to test before the stable release."
draft: false
lang: en
---
