...
excerpt: "GTK-based PDF readers on Linux -- Evince and Atril -- contain an argument injection vulnerability in ev_spawn(). A crafted PDF with a malicious page label or named destination is enough to trigger code execution."
draft: false
lang: en
---
