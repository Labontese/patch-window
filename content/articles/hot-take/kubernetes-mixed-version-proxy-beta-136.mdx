...
excerpt: "Mixed Version Proxy graduated to beta in Kubernetes 1.36 and is now on by default. It fixes the silent 404 that can trigger garbage collection during rolling control plane upgrades."
draft: false
lang: en
---
