...
excerpt: "Forge adds guardrails to local LLM tool-calling in Python. Lifts an 8B model from ~32% to 84% on its eval suite — no model swap, just a reliability wrapper."
draft: false
lang: en
---
