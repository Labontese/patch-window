...
excerpt: "Vault 2.0 is IBM rebranding 1.21, not a rebuild. Three breaking changes: Azure auth flipped, sys-endpoints need tokens, rekey automation will silently fail."
draft: false
lang: en
---
