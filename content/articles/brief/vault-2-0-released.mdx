---
title: "Vault 2.0 Is Out: The Version Bump Is IBM's Rebrand — Rekey Automation Will Break"
format: brief
...
excerpt: "HashiCorp Vault 2.0 jumped from 1.21 for administrative reasons, not a rebuild. Three real breaking changes affect operators: Azure auth precedence flipped, three sys-endpoints now require a token, and rekey automation runs unauthenticated no more."
draft: false
lang: en
---
