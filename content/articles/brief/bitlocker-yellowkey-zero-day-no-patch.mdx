---
title: "BitLocker YellowKey (CVE-2026-45585): what to do now"
format: brief
...
excerpt: "BitLocker's default TPM-only mode is the attack surface. YellowKey (CVE-2026-45585) needs physical access and a USB drive. Switch to TPM+PIN to block the published PoC."
draft: false
lang: en
---
