---
title: "BitLocker zero-day bypasses encryption, no patch yet"
format: brief
...
excerpt: "CVE-2026-45585 (YellowKey) gives an attacker shell access to a BitLocker volume using physical access and a USB drive. PoC is public, no patch exists. Enable TPM+PIN to block it."
draft: false
lang: en
---

A BitLocker zero-day named YellowKey (CVE-2026-45585) was published on 13 May 2026 by a security researcher using the alias Nightmare-Eclipse. The proof-of-concept is public on GitHub. The exploit targets Windows 11 and Windows Server 2022 and 2025. Microsoft has not shipped a patch but published a mitigation guide around 20 May — the workarounds described below remain the primary response.
...
There is no patch yet. Microsoft has published a mitigation guide but no fix. The mitigations are configuration-level:
...
*Updated 2026-05-23: CVE-2026-45585 confirmed. Microsoft published a mitigation guide around 20 May. No patch yet.*
