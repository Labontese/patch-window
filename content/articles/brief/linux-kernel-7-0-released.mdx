...
excerpt: "Linux 7.0 is out. SHA-1 module signing removed, NFSv4.0 becomes kconfig-optional, lazy preemption replaces the old default. Audit your config before upgrading."
draft: false
lang: en
---
