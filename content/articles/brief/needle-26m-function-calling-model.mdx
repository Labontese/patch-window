---
title: "Needle: a 26M model that beats 270M on tool calls"
format: brief
...
excerpt: "Needle is a 26M parameter model that outperforms models ten times its size on single-shot function calling. It runs locally and costs almost nothing per call."
draft: false
lang: en
---
