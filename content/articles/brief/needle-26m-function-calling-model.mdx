...
excerpt: "Needle is a 26M function-calling model that outperforms 270M+ rivals. Runs on CPU, open-source. Cut GPT-4o API costs by routing tool dispatch to a local model."
draft: false
lang: en
---
