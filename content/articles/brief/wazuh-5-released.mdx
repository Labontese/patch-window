...
excerpt: "Wazuh 5.0 beta1 rewrites agent comms and replaces OpenSearch with its own indexer. 4.x agents need upgrading. What breaks and what to test before migrating."
related:
  - format: guides
