...
Rex delivers: a review report in `artifacts/reviews/[slug]-review.md`.
```
...
Save your output to artifacts/drafts/[slug]-draft.md.
```
...
Save your review to artifacts/reviews/[slug]-review.md.
```
