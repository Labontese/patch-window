---
title: "seo-mcp: Google Search Console and Bing tools for your AI assistant"
format: deep-dive
...
excerpt: "I built a small MCP server that connects an AI assistant to live data from Google Search Console and Bing Webmaster Tools. Here is why I built it instead of using what existed, and what each of the ten tools actually does."
draft: false
lang: en
---
