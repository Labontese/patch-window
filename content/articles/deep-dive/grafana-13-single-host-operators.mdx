...
excerpt: "Grafana 13 upgrade checklist for single-host Docker Compose setups. Git Sync is GA, React 19 breaks community plugins, Unified Storage migrates automatically. Here is what to verify before you change the image tag."
draft: false
lang: en
---
