---
title: "AI agent telemetry: cutting prompt costs with data"
format: deep-dive
...
The stack does not know what work was done, only how many tokens were used. Correlating cost with task complexity requires task metadata the JSONL files do not contain. That is the next layer. The upstream problem — ensuring that the work being measured was well-defined to begin with — is a separate concern covered in [using grill-me as a delegation gate](/deep-dive/grill-me-ai-agents-multi-agent-workflow).
